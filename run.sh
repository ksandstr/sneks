...
MUNG="../mung"
exec kvm -serial stdio -display none -no-reboot -net none -kernel $MUNG/mbiloader/mbiloader -initrd "$MUNG/ia32-kernel,$MUNG/user/sigma0,root/root,sys/sysmem/sysmem,sys/test/systest $SNEKS_OPTS" $@
